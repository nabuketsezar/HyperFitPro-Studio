...
class DigitalTwinApiPackage(ToolPlugin):
    plugin_id = 'studio.digital_twin_api_package'
    name = 'Digital twin API package'
    category = 'Studio'
    description = 'Exports a lightweight JSON API payload for downstream digital twin integration.'
    requires_model = True
    requires_data = False
    requires_fit = True
...
TOOL_CLASS = DigitalTwinApiPackage
