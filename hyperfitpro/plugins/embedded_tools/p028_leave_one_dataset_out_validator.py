...
class LeaveOneDatasetOutValidator(ToolPlugin):
    plugin_id = 'diagnostics.leave_one_dataset_out_validator'
    name = 'Leave-one-dataset-out validator'
    category = 'Diagnostics'
    description = 'Generates a validation plan for leave-one-test-mode-out checks.'
    requires_model = True
    requires_data = True
    requires_fit = True
...
TOOL_CLASS = LeaveOneDatasetOutValidator
