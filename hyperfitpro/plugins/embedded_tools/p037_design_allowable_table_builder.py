...
class DesignAllowableTableBuilder(ToolPlugin):
    plugin_id = 'report.design_allowable_table_builder'
    name = 'Design allowable table builder'
    category = 'Report'
    description = 'Builds engineering tables at selected stretches/shears for preliminary allowables.'
    requires_model = True
    requires_data = True
    requires_fit = True
...
TOOL_CLASS = DesignAllowableTableBuilder
