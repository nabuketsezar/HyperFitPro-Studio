...
class StrainWindowSensitivity(ToolPlugin):
    plugin_id = 'plot.strain_window_sensitivity'
    name = 'Strain window sensitivity'
    category = 'Plot'
    description = 'Shows how data coverage changes when low, mid and high strain windows are isolated.'
...
TOOL_CLASS = StrainWindowSensitivity
