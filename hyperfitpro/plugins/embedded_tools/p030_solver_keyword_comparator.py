...
class SolverKeywordComparator(ToolPlugin):
    plugin_id = 'fea.solver_keyword_comparator'
    name = 'Solver keyword comparator'
    category = 'FEA'
    description = 'Compares available Abaqus, ANSYS, CalculiX, LS-DYNA and Marc export artifacts.'
...
TOOL_CLASS = SolverKeywordComparator
