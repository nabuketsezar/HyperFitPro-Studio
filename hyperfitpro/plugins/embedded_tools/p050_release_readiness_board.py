...
class ReleaseReadinessBoard(ToolPlugin):
    plugin_id = 'studio.release_readiness_board'
    name = 'Release readiness board'
    category = 'Studio'
    description = 'Creates an executive readiness board for calibration maturity and next actions.'
    requires_model = True
    requires_data = True
    requires_fit = True
...
TOOL_CLASS = ReleaseReadinessBoard
