...
class TrainingAssetBuilder(ToolPlugin):
    plugin_id = 'report.training_asset_builder'
    name = 'Training asset builder'
    category = 'Report'
    description = 'Creates training cards explaining model, data, optimization and export workflow.'
    requires_model = True
    requires_data = True
    requires_fit = True
...
TOOL_CLASS = TrainingAssetBuilder
