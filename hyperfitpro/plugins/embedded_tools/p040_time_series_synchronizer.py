...
class TimeSeriesSynchronizer(ToolPlugin):
    plugin_id = 'data.time_series_synchronizer'
    name = 'Time-series synchronizer'
    category = 'Data'
    description = 'Creates a synchronization guide for camera/DIC/load-cell test streams.'
...
TOOL_CLASS = TimeSeriesSynchronizer
