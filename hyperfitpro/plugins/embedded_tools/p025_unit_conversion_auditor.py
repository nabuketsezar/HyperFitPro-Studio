...
class UnitConversionAuditor(ToolPlugin):
    plugin_id = 'diagnostics.unit_conversion_auditor'
    name = 'Unit conversion auditor'
    category = 'Diagnostics'
    description = 'Audits stress/length/force scale hints and creates a unit consistency checklist.'
    requires_model = True
    requires_data = True
    requires_fit = False
...
TOOL_CLASS = UnitConversionAuditor
