...
class QualityGateSignoffSheet(ToolPlugin):
    plugin_id = 'report.quality_gate_signoff'
    name = 'Quality gate sign-off sheet'
    category = 'Report'
    description = 'Creates a sign-off checklist for calibration review and release.'
    requires_model = True
    requires_data = True
    requires_fit = True
...
TOOL_CLASS = QualityGateSignoffSheet
