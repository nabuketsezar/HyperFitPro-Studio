...
class StabilityHeatmapExplorer(ToolPlugin):
    plugin_id = 'plot.stability_heatmap'
    name = 'Stability heatmap explorer'
    category = 'Plot'
    description = 'Creates a strain-range heatmap for quick stability and extrapolation review.'
    requires_model = True
    requires_data = False
    requires_fit = True
...
TOOL_CLASS = StabilityHeatmapExplorer
