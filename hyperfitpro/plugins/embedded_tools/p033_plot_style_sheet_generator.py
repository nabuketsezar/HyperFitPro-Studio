...
class PlotStyleSheetGenerator(ToolPlugin):
    plugin_id = 'report.plot_style_sheet_generator'
    name = 'Plot style sheet generator'
    category = 'Report'
    description = 'Creates a consistent plot styling guide for reports and presentations.'
...
TOOL_CLASS = PlotStyleSheetGenerator
