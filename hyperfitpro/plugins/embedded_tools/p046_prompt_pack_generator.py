...
class PromptPackGenerator(ToolPlugin):
    plugin_id = 'advisor.ai_prompt_pack_generator'
    name = 'AI prompt pack generator'
    category = 'Advisor'
    description = 'Generates engineering prompts to review, validate and document the calibration.'
    requires_model = True
    requires_data = True
    requires_fit = True
...
TOOL_CLASS = PromptPackGenerator
