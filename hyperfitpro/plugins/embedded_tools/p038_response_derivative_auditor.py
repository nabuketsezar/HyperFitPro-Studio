...
class ResponseDerivativeAuditor(ToolPlugin):
    plugin_id = 'diagnostics.response_derivative_auditor'
    name = 'Response derivative auditor'
    category = 'Diagnostics'
    description = 'Audits approximate monotonicity and derivative sign of loaded test curves.'
...
TOOL_CLASS = ResponseDerivativeAuditor
