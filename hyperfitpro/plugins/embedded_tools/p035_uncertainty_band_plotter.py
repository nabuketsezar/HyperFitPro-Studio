...
class UncertaintyBandPlotter(ToolPlugin):
    plugin_id = 'plot.uncertainty_band'
    name = 'Uncertainty band plotter'
    category = 'Plot'
    description = 'Creates approximate uncertainty bands using fitted metric and parameter perturbation.'
    requires_model = True
    requires_data = True
    requires_fit = True
...
TOOL_CLASS = UncertaintyBandPlotter
