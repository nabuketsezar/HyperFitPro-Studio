...
class AutoReportComposer(ToolPlugin):
    plugin_id = 'report.auto_report_composer'
    name = 'Auto report composer'
    category = 'Report'
    description = 'Builds a proposed report structure from available model, data, fit and tool assets.'
    requires_model = True
    requires_data = False
    requires_fit = False
