...
class BootstrapParameterSampler(ToolPlugin):
    plugin_id = 'diagnostics.bootstrap_parameter_sampler'
    name = 'Bootstrap parameter sampler'
    category = 'Diagnostics'
    description = 'Creates a lightweight bootstrap-style parameter spread table around the fitted solution.'
    requires_model = True
    requires_data = True
    requires_fit = True
...
TOOL_CLASS = BootstrapParameterSampler
