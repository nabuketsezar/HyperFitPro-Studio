...
class CalibrationPackager(ToolPlugin):
    plugin_id = 'studio.calibration_packager'
    name = 'Calibration run packager'
    category = 'Studio'
    description = 'Creates a portable ZIP package of the current run folder and key calibration outputs.'
...
TOOL_CLASS = CalibrationPackager
