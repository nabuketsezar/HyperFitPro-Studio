...
class EngineeringChangeNote(ToolPlugin):
    plugin_id = 'studio.engineering_change_note'
    name = 'Engineering change note generator'
    category = 'Studio'
    description = 'Creates an ECN-style note for material model update and release review.'
    requires_model = True
    requires_data = False
    requires_fit = True
...
TOOL_CLASS = EngineeringChangeNote
