...
class SensitivityTornadoChart(ToolPlugin):
    plugin_id = 'plot.sensitivity_tornado'
    name = 'Sensitivity tornado chart'
    category = 'Plot'
    description = 'Produces a tornado chart ranking parameter magnitude and uncertainty influence.'
    requires_model = True
    requires_data = False
    requires_fit = True
...
TOOL_CLASS = SensitivityTornadoChart
