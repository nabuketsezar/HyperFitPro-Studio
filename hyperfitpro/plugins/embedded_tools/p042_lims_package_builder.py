...
class LimsPackageBuilder(ToolPlugin):
    plugin_id = 'studio.lims_package_builder'
    name = 'LIMS package builder'
    category = 'Studio'
    description = 'Builds a lab information management package manifest for traceability.'
    requires_model = True
    requires_data = True
    requires_fit = True
