...
class TestModeGapMatrix(ToolPlugin):
    plugin_id = 'advisor.test_mode_gap_matrix'
    name = 'Test mode gap matrix'
    category = 'Advisor'
    description = 'Scores missing uniaxial/biaxial/planar/shear/volumetric coverage by model family.'
    requires_model = True
    requires_data = True
    requires_fit = False
