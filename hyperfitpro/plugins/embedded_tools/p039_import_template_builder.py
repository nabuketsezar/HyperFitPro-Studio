...
class ImportTemplateBuilder(ToolPlugin):
    plugin_id = 'data.import_template_builder'
    name = 'Import template builder'
    category = 'Data'
    description = 'Generates ready-to-fill CSV templates for stress-strain and force-displacement tests.'
...
TOOL_CLASS = ImportTemplateBuilder
