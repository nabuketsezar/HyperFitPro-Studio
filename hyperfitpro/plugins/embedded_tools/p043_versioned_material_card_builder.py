...
class VersionedMaterialCardBuilder(ToolPlugin):
    plugin_id = 'fea.versioned_material_card_builder'
    name = 'Versioned material card builder'
    category = 'FEA'
    description = 'Creates versioned material-card metadata with release status and reviewer fields.'
    requires_model = True
    requires_data = False
    requires_fit = True
...
TOOL_CLASS = VersionedMaterialCardBuilder
