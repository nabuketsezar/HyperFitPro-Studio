...
class ParametricSweepBatch(ToolPlugin):
    plugin_id = 'lab.parametric_sweep_batch'
    name = 'Parametric sweep batch'
    category = 'Lab'
    description = 'Exports a batch grid of parameter multipliers for sensitivity or DOE studies.'
    requires_model = True
    requires_data = False
    requires_fit = True
...
TOOL_CLASS = ParametricSweepBatch
