...
class DecisionTreeModelSelector(ToolPlugin):
    plugin_id = 'advisor.decision_tree_model_selector'
    name = 'Decision tree model selector'
    category = 'Advisor'
    description = 'Writes a rule-based model selection decision tree based on test coverage and complexity.'
    requires_model = True
    requires_data = True
    requires_fit = False
...
TOOL_CLASS = DecisionTreeModelSelector
