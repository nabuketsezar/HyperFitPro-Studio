...
class FeasibilityMapPlotter(ToolPlugin):
    plugin_id = 'plot.feasibility_map'
    name = 'Feasibility map plotter'
    category = 'Plot'
    description = 'Creates a model feasibility map versus data quantity and parameter count.'
    requires_model = True
    requires_data = True
    requires_fit = False
...
TOOL_CLASS = FeasibilityMapPlotter
